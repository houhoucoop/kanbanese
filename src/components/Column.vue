  ...
  <div :id="idName" class="column">
    ...
    <div class="column__itembox">
      <transition-group name="slide-fade" mode="out-in">
        <div class="column__itembox__item" v-for="item in itemList" :key="item.time">
    ...
    <div class="column__additem">
      ...
      <div class="column__additem__input" v-else>
        <textarea name="" :id="idName + '-text'" cols="30" rows="5" @keyup.enter="addItem" v-model="holder" autofocus></textarea>
